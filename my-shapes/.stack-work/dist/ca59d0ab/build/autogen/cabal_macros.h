...
/* package my-shapes-0.1.0.0 */
#define VERSION_my_shapes "0.1.0.0"
#define MIN_VERSION_my_shapes(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "my-shapes-0.1.0.0-1u8ZCrX5ylSDv8e59Ost1k"

#define CURRENT_PACKAGE_KEY "my-shapes-0.1.0.0-1u8ZCrX5ylSDv8e59Ost1k"
