...
/* package SimpleSignalExample-0.1.0.0 */
#define VERSION_SimpleSignalExample "0.1.0.0"
#define MIN_VERSION_SimpleSignalExample(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "SimpleSignalExample-0.1.0.0"

#define CURRENT_PACKAGE_KEY "SimpleSignalExample-0.1.0.0"
